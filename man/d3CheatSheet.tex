...
\ifthenelse{\lengthtest { \paperwidth = 11in}}
	{ \geometry{top=.3in,left=.4in,right=.3in,bottom=.4in} }
...
\end{thm}\begin{thm} [ d3.geo.orthographic.raw ]  the raw azimuthal orthog proj
\end{thm}\begin{thm} [ d3.geo.stereographic.raw ]  the raw azimuthal stereog proj
