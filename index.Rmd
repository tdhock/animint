...
On the left hand panel, we can click the different colours to change the current selection and view the differences in the relationship between bill amount and tips. Notice how bill amount and tip have lower correlation amongst smokers (especially male smokers). The next section shows how we can leverage `clickSelects`, `showSelected`, and [other animint options]() to make more complex interactive animations.
...
lines_simple
structure(lines_simple, class = "animint")
```
...
structure(line_types, class = "animint")
```
...
structure(alphas, class = "animint")
```
...
points_simple
structure(points_simple, class = "animint")
```
...
s5 <- ggplot() + 
  ...
  ggtitle("geom_jitter")
s5
structure(list(s5 = s5), class = "animint")
```
...
g1 <- ggplot() + 
  ...
  ggtitle("geom_abline")
g1
structure(list(g1 = g1), class = "animint")
```
...
g2 <- ggplot() + 
  ...
  ggtitle("geom_ribbon")
g2
structure(list(g2 = g2), class = "animint")
```
...
g3
structure(list(g3 = g3), class = "animint")
```
...
g4 <- ggplot() + 
  ...
  ggtitle("geom_path")
g4
structure(list(g4 = g4), class = "animint")
```
...
g5
structure(list(g5 = g5), class = "animint")
```
...
g6
structure(list(g6 = g6), class = "animint")
```
...
g7
structure(list(g7 = g7), class = "animint")
```
...
g8 <- ggplot() + 
  ...
  xlab("Distribution")
g8
structure(list(g8 = g8), class = "animint")
```
...
g9 <- ggplot() + 
  ...
  ggtitle("geom_step")
g9
structure(list(g9 = g9), class = "animint")
```
...
contours
animint2dir(contours, "contours")
```

Since can take a few seconds to load all of the tiles, the contours are [here](contours)
...
structure(list(g13 = g13), class = "animint")
```
...
g14
structure(list(g14 = g14), class = "animint")
```
...
g15
structure(list(g15 = g15), class = "animint")
```
...
g16
structure(list(g16 = g16), class = "animint")
```
...
g17  
structure(list(g17 = g17), class = "animint")
```
...
structure(list(g18 = g18), class = "animint")
```
...
g19
structure(list(g19 = g19), class = "animint")
```
...
g20
structure(list(g20 = g20), class = "animint")
```
...
g21
structure(list(g21 = g21), class = "animint")
```
